        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <form:form action="save" method="post" modelAttribute="user">
                    ...
                    <div class="form-group">
                        <label for="password">Your Password (at least 5 words):</label>
                        <form:password path="password" class="form-control" required="true" oninput="validatePassword(this)"/>
                    </div>
                ...
                <script>
                    function validatePassword(input) {
                        ...
                        var passwordWords = password.trim().split(/\s+/);
                        var passwordValidationMessage = document.getElementById('passwordValidationMessage');
                        if (passwordWords.length < 5) {
                            passwordValidationMessage.textContent = "Password must contain at least 5 words.";
                        } else {
